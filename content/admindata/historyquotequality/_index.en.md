...
- The calculation of completeness is based on the [trading calendar of a stock exchange](../../basedata/instrumentbased/stockexchange/), which is derived either from an index or from a trading calendar rule set.
