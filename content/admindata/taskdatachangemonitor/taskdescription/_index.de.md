...
**Nachrichtenlöschung**: Alte Austauschnachrichten werden automatisch gelöscht, um den Speicherbedarf zu reduzieren. Der globale Parameter **gt.gtnet.del.message.recv** steuert die Aufbewahrungsdauer im Format «LP=1,HP=5,SL=5»:
...
4. Für Währungspaare ohne historische Kursdaten wird eine neue Aufgabe mit der ID 40 angelegt
...
## 39 - Bestände für einen oder alle Klienten wiederherstellen, normalerweise nach einem Import von einem Export
...
## 42 - Erzeugt den Handelskalender für Börsen durch einen Hauptindex
