...
## 22 - GTNet-Austauschprotokolle aggregieren
Dieser Aufgabentyp aggregiert GTNet-Austauschprotokolleinträge rollierend von kürzeren zu längeren Zeiträumen. Die Aggregation erfolgt in mehreren Stufen: Einzelne Einträge werden zu täglichen Zusammenfassungen aggregiert, tägliche zu wöchentlichen, wöchentliche zu monatlichen und monatliche zu jährlichen. Jede Aggregationsstufe hat einen konfigurierbaren Schwellenwert, der bestimmt, wann Einträge zur nächsten Stufe befördert werden. Der Standardzeitplan läuft täglich um 3:00 Uhr UTC. Diese Aggregation reduziert den Speicherbedarf und bewahrt gleichzeitig statistische Daten über die GTNet-Austauschaktivität im Zeitverlauf.
