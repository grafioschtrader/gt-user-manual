...
This defines the **upper set of** **trading days** for all **stock exchanges**. In principle, **no trading** takes place on **Saturdays** and **Sundays**. In most cases, only January 1 and December 25 are entered as global **non-trading days**. From this upper set, each [stock exchange](../../basedata/instrumentbased/stockexchange/) subtracts its own closed days, derived either from an index or from a trading calendar rule set.
