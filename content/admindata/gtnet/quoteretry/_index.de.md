...
- **Hintergrundaufgabe 21 «Wiederholungszähler für Konnektor(en) bei aktiven Instrumenten zurücksetzen»**: Diese Aufgabe setzt den Zähler unmittelbar auf 0, ohne den Konnektor erst aufzurufen. Sie eignet sich, um nach Behebung eines Konnektor-Ausfalls schnell wieder den Konnektor-Pfad zu aktivieren. Mehr dazu in der [Aufgabenbeschreibung](../../taskdatachangemonitor/taskdescription/).
