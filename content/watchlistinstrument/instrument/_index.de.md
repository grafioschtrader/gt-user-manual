...
- **GTNet als Fallback**: Ist die Funktion GTNet aktiviert und wird auf dem Instrument die Option «Erhalte historische Preisdaten» bzw. «Erhalte Intraday Preis» gesetzt, können Kursdaten auch dann über GTNet bezogen werden, wenn der konfigurierte Konnektor nicht oder nicht mehr funktioniert. Trotzdem wird empfohlen, einen funktionierenden Konnektor als Hauptdatenquelle vorzusehen. Mehr dazu in [Wiederholungszähler und GTNet-Fallback](../../admindata/gtnet/quoteretry/).
