...
Pro Instrument können standardmässig bis zu 20 Perioden erfasst werden. Eine Administratorin oder ein Administrator kann diese Grenze über die Limite **Wertpapier / Historische Periode** der Limitenart **Gesamtanzahl** anpassen, siehe [Limite Informationsklasse]({{% relref "/admindata/entitylimit" %}}). Die Fusszeile der Tabelle zeigt die aktuelle Anzahl und das erlaubte Maximum an.
{{% /notice %}}
