...
date: 2026-08-15T10:54:47+01:00
draft: false
weight: 8
archetype: "default"
---
...
Up to 20 periods per instrument can be entered by default. An administrator can adjust this limit through **Security / Historical period** of the limit type **Total number**, see [Limit information class]({{% relref "/admindata/entitylimit" %}}). The table footer shows the current count and the allowed maximum.
{{% /notice %}}
