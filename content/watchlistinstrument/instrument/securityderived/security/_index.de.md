...
- **Name**: Bei **Anleihen** und **Wandelanleihen** sollte der Name mit dem Zinssatz des Kupons beginnen. Zum Beispiel “0.0219 IBK 19-25” für die Anleihe der Industrial Bank of Korea. Derzeit gibt es in GT noch keine Funktionalität, die den Zinssatz aus dem Namen liest, andererseits wird der Zinssatz sonst nirgendwo im Wertpapier gespeichert.
...
#### Stückelung 
Bei Anleihen ist dies die kleinste handelbare Einheit, bei Festgeldern der Kurs. Derzeit gibt es keine Validierung bei Käufen und Verkäufen. Daher ist möglich, dass ein zahlungsunfähiger Gläubiger für die teilweise oder vollständige Rückzahlung andere Stückelungen wählt. Bei Anleihen hat diese Angabe daher vor allem Informationscharakter.
