...
Der Administrator legt das Kontingent über die Einstellung **gt.limit.day.HistoryquoteRead** in den [globalen Einstellungen](../../../../admindata/globalsettings/) fest (Standardwert 250 Instrumente). Benutzer mit erweiterten Rechten sind von dieser Begrenzung ausgenommen. Zudem kann der Administrator einzelnen Benutzern zeitlich befristet ein abweichendes Tageskontingent gewähren; dies geschieht im selben Dialog, mit dem auch die täglichen Änderungslimiten eines **Limit Benutzers** angepasst werden. Wer das Kontingent überschreitet, erhält eine Fehlermeldung und kann bis zum Folgetag keine weiteren, an diesem Tag noch nicht abgerufenen Instrumente laden. Wiederholte Überschreitungen können zur Sperrung des Kontos führen, die nur der Administrator aufheben kann.
