...
{{< mermaid >}}
flowchart TD
    A[Data provider changed or<br/>Job 35 triggered] --> B[Current prices copied to archive]
...
More on the underlying background task is available under [Background tasks]({{< relref "/admindata/taskdatachangemonitor/taskdescription" >}}) at Job 35.
