...
{{< mermaid >}}
flowchart TD
    A[Datenanbieter geändert oder<br/>Job 5 ausgelöst] --> B[Aktuelle Kurse ins Archiv kopiert]
...
Mehr zur auslösenden Hintergrundaufgabe steht unter [Hintergrundaufgaben]({{< relref "/admindata/taskdatachangemonitor/taskdescription" >}}) bei Job 5.
