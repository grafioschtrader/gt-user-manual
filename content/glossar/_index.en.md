...
#### Forex gain
The part of a result that arises purely from the change of the exchange rate against the main currency, and not from the instrument itself. It is shown as a separate column in the reports and can be negative even though the instrument has risen. Described in detail under [Forex gain]({{% ref "/reportportfolio#forex-gain" %}}).
