...
+ **Active until or maturity date**: Optional date up to which entries can be booked on this securities account; the behaviour matches that of the cash account. See [Deactivating an account]({{% ref "/tenantportfolio/cashaccount#deactivating-an-account" %}}).
