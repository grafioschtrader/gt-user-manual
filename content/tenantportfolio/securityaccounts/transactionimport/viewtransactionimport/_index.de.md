...
- **Gesamtsumme Überprüfung**: Aus den Angaben der importierten Transaktion wird die **Gesamtsumme** errechnet, diese muss mit dem entsprechenden Wert des **Feld "ta"** übereinstimmen. Eine in der [Importvorlage](../../../basedata/imptranstemplate/createimptranstemplate/) festgelegte Rundungstoleranz (**calcRounding**) wird dabei akzeptiert.
...
- **Erstelle Transaktion**: Die Transformation einer Importposition in eine Transaktion ist nur möglich, falls die Importposition noch **keine Transaktion** und keine "**vielleicht Transaktion**" hat. Liegt das Datum einer Importposition nach dem **Aktiv bis oder Fälligkeitstag** des zugeordneten Kontos oder Depots, wird die Erstellung für diese Position mit einer Fehlermeldung abgewiesen und übersprungen; die übrigen Positionen werden weiterhin verarbeitet. Siehe [Stilllegung eines Kontos]({{% ref "/tenantportfolio/cashaccount#stilllegung-eines-kontos" %}}).
