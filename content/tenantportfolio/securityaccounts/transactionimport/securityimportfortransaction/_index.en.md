...
If the import document contains a currency minor unit such as GBp/GBX (pence) or ZAc (cents), it is automatically converted into the main currency GBP or ZAR during the import. The search for and linking of the security via GTNet therefore always takes place with the main currency.
