...
### Bearbeiten Klient
Die Eigenschaften des Klienten wurden im **Registrierungsprozess** erfasst und können über den **Navigationsbereich** auf **Element Portfolios** angepasst werden.
...
### Funktionen
- **Währung Klient und Portfolios**: Auf dem **Element Portfolios** gibt es diese Funktion, sie setzt die **Währung** des **Klienten** und all seiner **Portfolios**.