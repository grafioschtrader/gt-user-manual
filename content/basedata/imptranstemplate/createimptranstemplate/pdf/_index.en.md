...
- _Line 2_: This line contains a [Regular Expression](https://en.wikipedia.org/wiki/Regular_expression). For it to work correctly, the expression must be defined as a non-capturing group **(?:…)**; otherwise, the grouping in GT may not function correctly.
