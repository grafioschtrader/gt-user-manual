...
Da sowohl die ISIN-Änderung als auch der Wertpapiertransfer Transaktionen erzeugen, werden sie abgelehnt, wenn der Klient das [Transaktionslimit pro Klient](../../transaction/) bereits erreicht hat. Liegt der Bestand noch darunter, wird die Aktion vollständig ausgeführt, auch wenn die Grenze dadurch geringfügig überschritten wird.
{{% /notice %}}
