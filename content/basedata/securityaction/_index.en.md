...
date: 2026-06-02T22:54:47+01:00
draft: false
weight: 65
archetype: "default"
---
...
Because both the ISIN change and the security transfer create transactions, they are rejected when the client has already reached the [per-client transaction limit](../../transaction/). If the count is still below the limit, the action is carried out in full, even if this slightly exceeds the limit.
{{% /notice %}}
