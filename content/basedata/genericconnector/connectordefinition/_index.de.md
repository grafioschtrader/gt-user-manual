...
- **GBX-Teiler**: Ob Kurse automatisch durch 100 geteilt werden sollen — nötig für Börsen, die in der Untereinheit der Währung notieren: die London Stock Exchange notiert in Pence (GBX bzw. GBp) statt Pfund, die Johannesburg Stock Exchange in Cents (ZAc) statt Rand. Die Teilung erfolgt nur bei Wertpapieren dieser Börsen mit der entsprechenden Währung (GBP bzw. ZAR); Indizes sind davon ausgenommen.
