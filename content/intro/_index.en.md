---
title: "Introduction"
date: 2021-06-20T15:00:00+01:00
draft: false
weight: 1
archetype: "default"
---
...
+ In GT, the combination of **ISIN** and **currency** of an instrument is **unique**. It is therefore not possible to enter the same ETF in EUR for the Frankfurt and Stuttgart trading venues, for example.
...
{{% notice info %}}
The information in this help refers to **GT** version **0.33.0**.
{{% /notice %}}