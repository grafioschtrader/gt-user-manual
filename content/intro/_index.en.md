...
## What can GT
+ **The software is free and open source**: GT is released as open source and can be found on [GitHub](https://github.com/grafioschtrader).
...
+ The investor who does not want to entrust his financial data to a non-transparent platform. You can **host GT yourself**, all you need is a [Raspberry Pi 4](https://www.raspberrypi.org/products/raspberry-pi-4-model-b/) with 4GB (possibly 2GB) of RAM.
...
{{% notice info %}}
The information in this help refers to **GT** version **0.36.1**.
{{% /notice %}}