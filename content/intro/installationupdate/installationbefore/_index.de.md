...
date: 2026-06-05T18:54:47+01:00
draft: false
weight: 55
archetype: "default"
---
...
Eine kleine Installation mit wenigen Benutzer läuft schon auf einem privaten [Raspberry Pi 4](https://www.raspberrypi.org/products/raspberry-pi-4-model-b/). Ein TLS Zertifikat kriegen Sie bei [Let's Encrypt](https://letsencrypt.org/) gratis. Kostenlose freie dynamische DNS gibt es beispielsweise bei [DuckDNS](https://www.duckdns.org/). Leider ist bei vielen Internetanbietern die Upload Geschwindigkeit noch immer sehr gering, dies kann zu Verzögerungen bei externen Zugriffen auf Ihren an das Internet angeschlossenen Heim-Server führen.
