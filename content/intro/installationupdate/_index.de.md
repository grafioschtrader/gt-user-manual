...
Gewisse systemweite Einstellungen müssen übe application.properties vorgenommen werden. Beispielsweise kann ein API-Key einer Datenquelle nur über `application.properties` eingetragen werden.
